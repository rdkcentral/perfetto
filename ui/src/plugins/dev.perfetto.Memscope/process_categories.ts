...
// theme_provider.scss. The palette currently has 24 categorical colors plus
// a dedicated neutral. UNKNOWN always uses the neutral; everyone else gets
// `--pf-chart-color-${index+1}`. Keep the count <= palette size or extend
// the palette in theme_provider.scss.
